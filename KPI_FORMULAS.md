...
#### Average Lead Time
**Formula**: `AVG(goods_receipts.Receipt_Date - purchase_orders.Expected_Date)`
...
**Formula**: `COUNT(goods_receipts WHERE Receipt_Date > purchase_orders.Expected_Date)`
- Join: goods_receipts → purchase_orders on PO_No
...
- Columns: PO_No, Supplier_ID, Item_ID, Expected_Date, Receipt_Date, Delay_Days
- Delay_Days = Receipt_Date - Expected_Date
...
2. Calculate delay per PO: `Receipt_Date - Expected_Date`
