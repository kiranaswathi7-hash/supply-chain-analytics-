...
def show():
    ...
    po_gr_supplier['Lead_Time_Days'] = (po_gr_supplier['Receipt_Date'] - po_gr_supplier['Expected_Receipt_Date']).dt.days
    ...
    delay_cols = ['PO_No', 'Supplier_ID', 'Supplier_Name', 'Item_ID', 'Expected_Receipt_Date', 'Receipt_Date', 'Delay_Days']
    ...
    if len(delay_analysis) > 0:
        ...
        st.dataframe(
            ...
            column_config={
                ...
                'Expected_Receipt_Date': st.column_config.DateColumn(format="YYYY-MM-DD"),
