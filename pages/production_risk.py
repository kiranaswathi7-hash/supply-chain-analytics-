...
def show():
    ...
    if len(blocked_mo_data) > 0:
        ...
        blocked_mo_full = blocked_mo_full.merge(
            data['items_master'][['Item_ID', 'Description', 'Item_Type']],
    ...
    fig_mo_status.update_layout(xaxis_title="Status", yaxis_title="Count")
    ...
    if len(component_shortage_summary) > 0:
        ...
        component_shortage_summary = component_shortage_summary.merge(
            data['items_master'][['Item_ID', 'Description']],
            left_on='Component_Item_ID',
            right_on='Item_ID',
            how='left'
        )
        ...
        fig_top_shortage.update_layout(xaxis_title="Total Shortage Quantity", yaxis_title="Component")
